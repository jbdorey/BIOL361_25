...
> **Q4:** Can you make a new column with the **median** elevational values?
...
> **Q5:** Can you restrict the map view of *AusEleMap_points* to Australia's North East corner? **Hint**: run `?ggplot2::ylim()` and `?ggplot2::xlim()` and pay attention to the latitude and lonigtude values.
